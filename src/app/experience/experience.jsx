...
import RevealOnScroll from "@/app/components/clientComponents/revealOnScroll";
import TimelineIcon from "@/app/experience/timelineIcon";
import TimelineElement from "@/app/experience/timelineElement";
...
const experiences = [
    ...
    new ExperienceEntry("Android developer @DSGroup",
    ...
    new ExperienceEntry("Android/Flutter Developer & Scrum Member \n@DSGroup",
    ...
    new ExperienceEntry("ATC Flutter Certified Application Developer",
    ...
    new ExperienceEntry("Google Developers Android Certification",
    ...
    new ExperienceEntry("PSM1 (Professional Scrum Master I)",
    ...
    new ExperienceEntry("Flutter Developer & Product designer \n@Kurt",
    ...
    new ExperienceEntry("Resuming university",
