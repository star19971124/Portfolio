...
function FloatingActionButton() {
    ...
    return <div className={`fixed bottom-0 right-0 mb-6 mr-6 transition-all duration-150  ${isButtonVisible ? 'opacity-100 scale-100': 'opacity-0 scale-0 pointer-events-none'}`}>
        <a href="#home">
